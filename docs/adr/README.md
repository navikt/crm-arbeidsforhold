...
| [ADR-0002](0002-accountcontactrelation-for-personkontoer.md)      | AccountContactRelation objekt brukes for kontakter tilknyttet Personkontoer                        | Foreslått        | 2025-08-26 |
| [ADR-0003](0003-e-post-for-personkonto-via-aareg-og-krr.md)       | Håndtering av e-postadresse for personkonto via AAREG og KRR                                       | Foreslått        | 2025-08-27 |
...
**Datoene går bakover.** ADR-0002 og ADR-0003 er datert august 2025. ADR-0001 er datert april 2026. Nummereringen følger altså ikke kronologi.
