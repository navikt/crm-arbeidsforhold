...
- [x] Renamde dei 13 legacy-testmetodane i `AAREG_HomeControllerTest` til åtferdsbaserte namn. Prettier passerer, og ingen `test`-prefiks står att i klassen. Editorvalidering er framleis org-avhengig på grunn av manglande Salesforce-/custom-object-typar.
