...
- [ ] Prioritert naming-/ApexDoc-oppryddingsliste (basert på kartlegginga): (1) leggje til ApexDoc på dei 13 produksjonsklassane utan dokumentasjon, (2) avklare namnekonvensjonsbrota (særleg `AAREG_checkObjectTypeNameche`, som ser ut til å ha eit duplikat/nesten-duplikat i `AAREG_CheckObjectTypeNamingTest`), (3) vurdere om dei 186 legacy-testnamna skal ryddast opp gradvis. Kvar av desse skal takast som eiga, avgrensa TDD-/review-skive; ikkje masse-rename utan migreringsplan, og `force-app/unpackagable/` skal ikkje endrast utan eksplisitt godkjenning.
