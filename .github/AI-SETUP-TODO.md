...
- [x] Renamde 181 legacy-testmetodar i dei redigerbare testklassane til åtferdsbaserte namn. Live-søket viser no berre dei 2 read-only-metodane i `force-app/unpackagable/`. Prettier passerer, og ingen `test`-prefiks står att i dei rydda klassane. Editorvalidering er framleis org-avhengig på grunn av manglande Salesforce-/custom-object-typar. `force-app/unpackagable/` er ikkje endra.
